 ...
 * único processo de monitorização: a thread de execução, a instância da pipeline,
 * a configuração original e as janelas de UI associadas (monitorização e erro).
 *
 ...
 * @see main.java.com.gsmart.Gui.windows.MonitoringWindow
 */
public class PipelineTask {
     ...
     *
     * @param description Uma descrição legível da tarefa (ex: "Fonte: ThingsBoard") para exibição na UI.
     ...
     * @param config A configuração original usada para iniciar esta tarefa, útil para a reiniciar posteriormente.
     ...
     * <p>
     * Este método é chamado quando o utilizador interage com a UI para forçar uma
     * tentativa de reconexão imediata, sem aguardar pelo temporizador automático.
     */
