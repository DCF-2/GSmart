...
public class DatabaseManager {
     ...
     *
     * @return Uma lista de objetos {@link main.java.com.gsmart.model.User}.
     */
    public static java.util.List<main.java.com.gsmart.model.User> getAllUsers() {
        java.util.List<main.java.com.gsmart.model.User> users = new java.util.ArrayList<>();
        String sql = """
    ...
    """;
        ...
        try (Connection conn = getConnection();
            ...
            while (rs.next()) {
                users.add(new main.java.com.gsmart.model.User(
                        rs.getInt("id"),
